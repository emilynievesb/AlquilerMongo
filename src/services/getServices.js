...
const obtenerNumeroAlquileres = async () => {
  const alquileres = new Alquiler();
  return await alquileres.obtenerNumeroAlquileres();
};

const obtenerCarrosGrandesDisponibles = async () => {
  const carros = new Sucursal_automovil();
