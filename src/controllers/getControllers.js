...
const obtenerClientesConAlquilerController = async (req, res, next) => {
  try {
    const clientes = await obtenerClientesConAlquiler();
    res.status(200).json(clientes);
  } catch (error) {
    res.status(500).json(error);
  }
...
const obtenerCarrosController = async (req, res, next) => {
  try {
...
const obtenerNumeroCarrosSucursalController = async (req, res, next) => {
  try {
    const numero = await obtenerNumeroCarrosSucursal();
    res.status(200).json(numero);
  } catch (error) {
    res.status(500).json(error);
  }
...
const obtenerNumeroAlquileresController = async (req, res, next) => {
  try {
    const numero = await obtenerNumeroAlquileres();
    res.status(200).json(numero);
  } catch (error) {
    res.status(500).json(error);
  }
...
const obtenerClienteReservaController = async (req, res, next) => {
  try {
    const { id } = req.query;
    const cliente = await obtenerClienteReserva(id);
    res.status(200).json(cliente);
  } catch (error) {
    res.status(500).json(error);
  }
...
const obtenerAlquileresEntreFechasController = async (req, res, next) => {
  try {
    const alquileres = await obtenerAlquileresEntreFechas();
    res.status(200).json(alquileres);
  } catch (error) {
    res.status(500).json(error);
  }
